        ...
        custom_highlights = ''
                    function(colors)
                    	...
                    	return {
                    		...
                    		-- DAP UI (matched to Treesitter palette)
                    		DapUINormal = { bg = bg },
                    		DapUIVariable = { fg = "#8fc7ff" },
                    		DapUIScope = { fg = "#d2ccff", style = { "italic" } },
                    		DapUIType = { fg = "#f0c0a8" },
                    		DapUIValue = { fg = "#ded6cf" },
                    		DapUIModifiedValue = { fg = "#d2ccff", style = { "italic" } },
                    		DapUIDecoration = { fg = "#e3cbeb" },
                    		DapUIThread = { fg = "#8fc7ff" },
                    		DapUIStoppedThread = { fg = "#d2ccff", style = { "italic" } },
                    		DapUIFrameName = { fg = "#ded6cf" },
                    		DapUICurrentFrameName = { fg = "#8fc7ff", style = { "italic" } },
                    		DapUISource = { fg = "#a4dfae" },
                    		DapUILineNumber = { fg = "#999999" },
                    		DapUIFloatNormal = { bg = is_neovide and "#1e1e1f" or "NONE" },
                    		DapUIFloatBorder = { fg = "#e3cbeb", bg = is_neovide and "#1e1e1f" or "NONE" },
                    		DapUIWatchesEmpty = { fg = "#999999", style = { "italic" } },
                    		DapUIWatchesValue = { fg = "#ded6cf" },
                    		DapUIWatchesError = { fg = "#d2ccff", style = { "italic" } },
                    		DapUIBreakpointsPath = { fg = "#a4dfae" },
                    		DapUIBreakpointsInfo = { fg = "#ded6cf" },
                    		DapUIBreakpointsCurrentLine = { fg = "#8fc7ff", style = { "italic" } },
                    		DapUIBreakpointsLine = { fg = "#ded6cf" },
                    		DapUIBreakpointsDisabledLine = { fg = "#999999", style = { "italic" } },
                    		DapUIPlayPause = { fg = "#a4dfae" },
                    		DapUIRestart = { fg = "#d5f288" },
                    		DapUIStop = { fg = "#d2ccff" },
                    		DapUIUnavailable = { fg = "#999999" },
                    		DapUIStepOver = { fg = "#e3cbeb" },
                    		DapUIStepInto = { fg = "#e3cbeb" },
                    		DapUIStepBack = { fg = "#e3cbeb" },
                    		DapUIStepOut = { fg = "#e3cbeb" },
                    		DapUIWinSelect = { fg = "#b8d7f9" },
                    		DapUIEndofBuffer = { fg = bg },
                    		DapUIEndOfBuffer = { fg = bg },
