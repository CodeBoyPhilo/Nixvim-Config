        ...
        custom_highlights = ''
                    function(colors)
                    	...
                    	return {
                    		...
                    		Statement = { fg = "#d2ccff", style = {"italic", "bold"}},
          							Conditional = { fg = "#d2ccff" },
          							Repeat = { fg = "#d2ccff" },
                    		Label = { fg = "#cbd5e1"},
                    		Operator = { fg = "#b8d7f9" },
                    		Keyword = { fg = "#d2ccff", style = { "italic", "bold"}},
                    		PreProc = { fg = "#b8d7f9"},
                    		Include = { fg = "#8fc7ff"},
                    		...
                    		["@property"] = { fg = "#ded6cf" },
          							...
          							["@operator"] = { fg = "#e3cbeb" },
          							["@keyword"] = { fg = "#d2ccff", style = { "italic", "bold" } },
          							["@keyword.function"] = { fg = "#d2ccff", style = { "italic", "bold" } },
          							["@keyword.conditional"] = { fg = "#d2ccff", style = { "italic", "bold" } },
          							["@keyword.repeat"] = { fg = "#d2ccff", style = { "italic", "bold" } },
          							["@keyword.exception"] = { fg = "#d2ccff", style = { "italic", "bold" } },
          							["@keyword.type"] = { fg = "#d2ccff", style = { "italic", "bold" } },
          							["@keyword.operator"] = { fg = "#d2ccff", style = { "italic", "bold" } },
          							...
          							["@function.builtin"] = { fg = "#ded6cf" },
          							["@function.builtin.python"] = { fg = "#ded6cf" },
          							["@function"] = { fg = "#8fc7ff" },
                    		["@string"] = { fg = "#a4dfae", },
